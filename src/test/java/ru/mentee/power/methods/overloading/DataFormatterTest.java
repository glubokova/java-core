...
class DataFormatterTest {
    ...
    @Test
    public void testForatIntWithPefixAndSufix() {
    ...
    @Test
    public void testFormateDate() throws ParseException {
    ...
    @Test
    public void testFormateDateWithPattern() throws ParseException {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        Date date = sdf.parse("2023-01-15");
